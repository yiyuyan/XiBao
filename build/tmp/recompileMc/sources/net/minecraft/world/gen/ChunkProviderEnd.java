...
public class ChunkProviderEnd implements IChunkProvider
{
    ...
    public void populate(IChunkProvider chunkProvider, int x, int z)
    {
        ...
        net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(new net.minecraftforge.event.terraingen.PopulateChunkEvent.Pre(chunkProvider, endWorld, endWorld.rand, x, z, false));
        BlockPos blockpos = new BlockPos(x * 16, 0, z * 16);
        this.endWorld.getBiomeGenForCoords(blockpos.add(16, 0, 16)).decorate(this.endWorld, this.endWorld.rand, blockpos);
        net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(new net.minecraftforge.event.terraingen.PopulateChunkEvent.Post(chunkProvider, endWorld, endWorld.rand, x, z, false));
