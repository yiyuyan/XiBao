...
public class ChunkProviderServer implements IChunkProvider
{
    ...
    public Chunk originalLoadChunk(int chunkX, int chunkZ)
    {
        ...
        if (chunk == null)
        {
            ...
            if (!added)
            {
                net.minecraftforge.fml.common.FMLLog.bigWarning("There is an attempt to load a chunk (%d,%d) in di    >mension %d that is already being loaded. This will cause weird chunk breakages.", chunkX, chunkZ, worldObj.provider.getDimensionId());
            }
