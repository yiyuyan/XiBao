...
public class ChunkProviderHell implements IChunkProvider
{
    ...
    public void populate(IChunkProvider chunkProvider, int x, int z)
    {
        ...
        net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(new net.minecraftforge.event.terraingen.PopulateChunkEvent.Pre(chunkProvider, worldObj, hellRNG, x, z, false));
        BlockPos blockpos = new BlockPos(x * 16, 0, z * 16);
        ChunkCoordIntPair chunkcoordintpair = new ChunkCoordIntPair(x, z);
        this.genNetherBridge.generateStructure(this.worldObj, this.hellRNG, chunkcoordintpair);

        boolean doGen = net.minecraftforge.event.terraingen.TerrainGen.populate(chunkProvider, worldObj, hellRNG, x, z, false, net.minecraftforge.event.terraingen.PopulateChunkEvent.Populate.EventType.NETHER_LAVA);
        ...
        doGen = net.minecraftforge.event.terraingen.TerrainGen.populate(chunkProvider, worldObj, hellRNG, x, z, false, net.minecraftforge.event.terraingen.PopulateChunkEvent.Populate.EventType.FIRE);
        ...
        doGen = net.minecraftforge.event.terraingen.TerrainGen.populate(chunkProvider, worldObj, hellRNG, x, z, false, net.minecraftforge.event.terraingen.PopulateChunkEvent.Populate.EventType.GLOWSTONE);
        ...
        doGen = net.minecraftforge.event.terraingen.TerrainGen.populate(chunkProvider, worldObj, hellRNG, x, z, false, net.minecraftforge.event.terraingen.PopulateChunkEvent.Populate.EventType.NETHER_LAVA2);
        ...
        net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(new net.minecraftforge.event.terraingen.PopulateChunkEvent.Post(chunkProvider, worldObj, hellRNG, x, z, false));
