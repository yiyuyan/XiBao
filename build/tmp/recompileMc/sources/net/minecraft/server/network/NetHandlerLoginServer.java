    ...
    public void update()
    {
        ...
        else if (this.currentLoginState == NetHandlerLoginServer.LoginState.DELAY_ACCEPT)
        {
            ...
            if (entityplayermp == null)
            {
                ...
                net.minecraftforge.fml.common.network.internal.FMLNetworkHandler.fmlServerHandshake(this.server.getConfigurationManager(), this.networkManager, this.player);
                this.player = null;
            }
        }
