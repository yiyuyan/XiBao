...
public abstract class GradleStartCommon
{
    ...
    static final File       SRG_DIR       = new File("E:/.gradle/caches/minecraft/de/oceanlabs/mcp/mcp_stable/22/srgs");
    static final File       SRG_NOTCH_SRG = new File("E:/.gradle/caches/minecraft/de/oceanlabs/mcp/mcp_stable/22/srgs/notch-srg.srg");
    static final File       SRG_NOTCH_MCP = new File("E:/.gradle/caches/minecraft/de/oceanlabs/mcp/mcp_stable/22/srgs/notch-mcp.srg");
    static final File       SRG_SRG_MCP   = new File("E:/.gradle/caches/minecraft/de/oceanlabs/mcp/mcp_stable/22/srgs/srg-mcp.srg");
    static final File       SRG_MCP_SRG   = new File("E:/.gradle/caches/minecraft/de/oceanlabs/mcp/mcp_stable/22/srgs/mcp-srg.srg");
    static final File       SRG_MCP_NOTCH = new File("E:/.gradle/caches/minecraft/de/oceanlabs/mcp/mcp_stable/22/srgs/mcp-notch.srg");
    static final File       CSV_DIR       = new File("E:/.gradle/caches/minecraft/de/oceanlabs/mcp/mcp_stable/22");
